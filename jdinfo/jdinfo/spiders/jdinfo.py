...
#        item["property"] = propertyStr
        ...
        item['detail'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", str(detail[0]))
        item['detail'] = re.sub(re.compile(r"//[^/]+?/", re.S), "/upload/", item['detail'])
        ...
        item['preview'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview'])
        item['preview_n0'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n0'])
        item['preview_n1'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n1'])
        item['preview_n2'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n2'])
        item['preview_n3'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n3'])
        item['preview_n4'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n4'])
        item['preview_n5'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n5'])
        item['preview_n6'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n6'])
        item['preview_n7'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n7'])
        item['preview_n8'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n8'])
        item['preview_n9'] = re.sub(re.compile(r"http[s]?://[^/]+?/", re.S), "/upload/", item['preview_n9'])
        #print(item)
        yield item